...
import com.esan.mohammad.ppmtool.services.ProjectService;
...
public class ProjectController {
    ...
    public ResponseEntity<?> deleteProjectByIdentifier(@PathVariable String project_id,Principal principal){
        projectService.deleteProjectByIdentifier(project_id,principal.getName());
        return new ResponseEntity<String>("Project with ID "+project_id+" is Deleted ",HttpStatus.OK);
    }
